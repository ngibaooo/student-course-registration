...
from app.repositories.admin.admin_course_repository import (
    CourseRepository
)

from app.services.admin.admin_course_service import (
    CourseService
)

from app.schemas.admin.admin_course_schemas import (
    CourseCreate,
    CourseUpdate
)
